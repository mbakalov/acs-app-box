    ...
    return (
      <header>
        <Navbar className="navbar-expand-sm navbar-toggleable-sm ng-white border-bottom box-shadow mb-3" container light>
          <NavbarBrand tag={Link} to="/">ACSAppBox</NavbarBrand>
          ...
          <Collapse className="d-sm-inline-flex flex-sm-row-reverse" isOpen={!this.state.collapsed} navbar>
            <ul className="navbar-nav flex-grow">
              ...
              <NavItem>
                <NavLink tag={Link} className="text-dark" to="/Chats">Chats</NavLink>
              </NavItem>
              <NavItem>
              ...
              <NavItem>
                <NavLink tag={Link} className="text-dark" to="/token">ACS Token Example</NavLink>
              </NavItem> */}
              <LoginMenu>
              </LoginMenu>
            </ul>
