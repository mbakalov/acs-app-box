...
namespace ACSAppBox.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var acsUserId = (await _communicationIdentityClient.CreateUserAsync()).Value;
                user.CommunicationUserId = acsUserId.Id;
